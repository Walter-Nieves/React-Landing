  ...
  return (
    <section className="bg-gray-300 w-screen max-w-[2000px]  h-full flex flex-col justify-center items-center">
      <div className="flex flex-col  justify-center items-center bg-gray-300 w-[84%] ">
        ...
        <strong className="animate-bounce mb-20 text-9xl max-md:text-7xl max-md:scale-0 scale-[1.5] bg-[linear-gradient(to_bottom,#FFD700_0%,#FFD700_50%,#0033A0_50%,#0033A0_75%,#CE1126_75%,#CE1126_100%)] bg-clip-text text-transparent">
        ...
        <div className=" flex flex-col w-[84%]">
          <p className="text-justify text-3xl my-10 justify-center">
