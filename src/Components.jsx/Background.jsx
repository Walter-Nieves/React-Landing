...
function Background() {
  ...
  return (
    ...
    <div className= {`  fixed -z-50 w-screen h-screen flex justify-center ${backgroundAnimate}`}>
      ...
      {/* div de informacion */}
      <div className={`flex flex-col justify-center items-center w-[34.4rem] max-w-[37.5rem] max-sm:w-[25rem] h-[17.5rem] max-tablet:h-40
       absolute top-[16rem] max-xl:top-96 max-tablet:top-40 left-2 right-0 p-2 rounded-lg text-center space-y-[-2rem] ${appearAnimate ? "bg-black/25" : "bg-black/0"}`}>
